...
export default function RootLayout() {
  ...
  return (
    <div className="flex">
      <header
        ref={headerRef}
        className={`h-96 top-0 transform bg-red-200 px-6 py-5 transition-all duration-500 ease-in-out ${
        ...
        <div className="items-center justify-between">
          ...
          <nav
            className={`order-last mt-2 flex-col items-center  md:mt-0 md:flex md:w-auto ${
              !isMenuOpen ? "hidden" : ""
            }`}>
